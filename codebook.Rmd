...
---
This is the codebook for UCI HAR Dataset formatting in a tidy version.

Data Set and Attribute Information can be found in README.txt; therefore, it will be omitted from this codebook in order to avoid the redunduncy of information.
